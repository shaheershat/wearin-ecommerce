# Generated by Django 4.2.23 on 2025-07-18 15:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tag_text', models.CharField(default='SALE', help_text="Text to display as a tag on product cards (e.g., 'SALE', '20% OFF').", max_length=20)),
                ...
                ('discount_amount', models.DecimalField(blank=True, decimal_places=2, help_text='Fixed discount amount (e.g., 50.00 for $50 off).', max_digits=10, null=True)),
